  ...
  res.end(`
    <html>
      <head>
        ...
        <style>
          body { font-family: 'Inter', -apple-system, sans-serif; background: #f4f7f6; display: flex; justify-content: center; align-items: center; min-height: 100vh; margin: 0; }
          ...
          .btn { display: block; width: 100%; padding: 14px; margin: 12px 0; border-radius: 50px; text-decoration: none; font-weight: 600; transition: transform 0.2s; }
          .btn:active { transform: scale(0.98); }
          .btn-wa { background: #25d366; color: white; }
          .btn-tel { background: #333; color: white; }
        </style>
      </head>
      <body>
        <div class="card">
